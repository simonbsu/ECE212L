...
/******** DO NOT MODIFY ********/
wire clk_1Hz;       //Generate Internal 1Hz clk
wire btnC_1Hz;     //Stretch load signal

//If running simulation, output clk frequency is 100MHz, else 1Hz
`ifndef SYNTHESIS
    assign clk_1Hz = clk;
`else
...
//Use "clk_1Hz" as clk signal to stopwatch and timer modules
stopwatch inst_sw(
    .rst(btnC),
    .clk(clk_1Hz),
    .state(led[8:3]),
